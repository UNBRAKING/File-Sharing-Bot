...
APP_ID = int(os.environ.get("APP_ID", "7d2c9a5628814e1430b30a1f0dc0165b"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "26614080")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002170894977"))
